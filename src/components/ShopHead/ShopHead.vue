<template>
  <div class="shop-header">
    ...
    <div class="header-content">
      <h2 class="content-title" @click="toogleshopshow">
    ...
    <div class="shop-header-discounts" v-if="info.supports">
      <div class="discounts-left" @click="tooglesupportshow">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="shopshow" v-if="info.supports">
